	...
	*/
	...
	class facebookController extends Controller {
		...
		public function base() {
			...
			$this->set('oauth', $fb->connect());
		}

		public function redirect() {
			$fb = new FacebookConnect();
			$token = $fb->getAccessToken(); // Save the $token to the database

			// The $fb->getData call can be on a different controller
			$data = $fb->getData($token, 'me');
